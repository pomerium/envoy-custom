...
public:
  ...
  virtual void onKexStarted(bool initial) PURE;
  virtual void onKexCompleted(std::shared_ptr<KexResult> kex_result, bool initial) PURE;
...
private:
  ...
  absl::Status sendKexInitMsg() noexcept;
