...
const wire::Message& SSHResponseHeaderFrame::message() const {
  return *msg_;
}
...
const wire::Message& SSHRequestCommonFrame::message() const {
  return *msg_;
}
...
const wire::Message& SSHResponseCommonFrame::message() const {
  return *msg_;
}
