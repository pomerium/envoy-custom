...
// Validate checks the field values on FilterMetadata with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *FilterMetadata) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on FilterMetadata with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in FilterMetadataMultiError,
// or nil if none found.
func (m *FilterMetadata) ValidateAll() error {
	return m.validate(true)
}

func (m *FilterMetadata) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return FilterMetadataMultiError(errors)
	}

	return nil
}

// FilterMetadataMultiError is an error wrapping multiple validation errors
// returned by FilterMetadata.ValidateAll() if the designated constraints
// aren't met.
type FilterMetadataMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m FilterMetadataMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m FilterMetadataMultiError) AllErrors() []error { return m }

// FilterMetadataValidationError is the validation error returned by
// FilterMetadata.Validate if the designated constraints aren't met.
type FilterMetadataValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e FilterMetadataValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e FilterMetadataValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e FilterMetadataValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e FilterMetadataValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e FilterMetadataValidationError) ErrorName() string { return "FilterMetadataValidationError" }

// Error satisfies the builtin error interface
func (e FilterMetadataValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = FilterMetadataValidationError{}
