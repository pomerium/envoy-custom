...
type CodecConfig struct {
	...
	ActiveStreamTracker *ActiveStreamTrackerConfig `protobuf:"bytes,5,opt,name=active_stream_tracker,json=activeStreamTracker,proto3" json:"active_stream_tracker,omitempty"`
...
func (x *CodecConfig) GetActiveStreamTracker() *ActiveStreamTrackerConfig {
	if x != nil {
		return x.ActiveStreamTracker
	}
	return nil
}

type ActiveStreamTrackerConfig struct {
	state         protoimpl.MessageState     `protogen:"open.v1"`
...
func (x *ActiveStreamTrackerConfig) Reset() {
	*x = ActiveStreamTrackerConfig{}
	mi := &file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ActiveStreamTrackerConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ActiveStreamTrackerConfig) ProtoMessage() {}

func (x *ActiveStreamTrackerConfig) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ActiveStreamTrackerConfig.ProtoReflect.Descriptor instead.
func (*ActiveStreamTrackerConfig) Descriptor() ([]byte, []int) {
	return file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_rawDescGZIP(), []int{1}
}

func (x *ActiveStreamTrackerConfig) GetFilters() []*v3.TypedExtensionConfig {
	if x != nil {
		return x.Filters
	}
	return nil
...
type ClusterEndpointManagerConfig struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ClusterEndpointManagerConfig) Reset() {
	*x = ClusterEndpointManagerConfig{}
	mi := &file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ClusterEndpointManagerConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClusterEndpointManagerConfig) ProtoMessage() {}

func (x *ClusterEndpointManagerConfig) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ClusterEndpointManagerConfig.ProtoReflect.Descriptor instead.
func (*ClusterEndpointManagerConfig) Descriptor() ([]byte, []int) {
...
func (x *UpstreamCluster) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpstreamCluster) ProtoMessage() {}

func (x *UpstreamCluster) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpstreamCluster.ProtoReflect.Descriptor instead.
...
func (x *UpstreamCluster) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *UpstreamCluster) GetEdsConfig() *v3.ConfigSource {
	if x != nil {
		return x.EdsConfig
	}
	return nil
...
func (x *ChannelMessage) GetChannelEvent() *ChannelEvent {
	if x != nil {
		if x, ok := x.Message.(*ChannelMessage_ChannelEvent); ok {
...
type ChannelMessage_ChannelEvent struct {
...
func (*ChannelMessage_ChannelEvent) isChannelMessage_Message() {}
...
type ChannelEvent struct {
	...
	//
	//	*ChannelEvent_ExternalChannelOpened
	//	*ChannelEvent_ExternalChannelClosed
...
func (x *ChannelEvent) GetExternalChannelOpened() *ChannelEvent_ExternalChannelOpenedEvent {
	if x != nil {
		if x, ok := x.Event.(*ChannelEvent_ExternalChannelOpened); ok {
			return x.ExternalChannelOpened
		}
	}
	return nil
}

func (x *ChannelEvent) GetExternalChannelClosed() *ChannelEvent_ExternalChannelClosedEvent {
	if x != nil {
		if x, ok := x.Event.(*ChannelEvent_ExternalChannelClosed); ok {
			return x.ExternalChannelClosed
		}
	}
	return nil
}
...
type ChannelEvent_ExternalChannelOpened struct {
	ExternalChannelOpened *ChannelEvent_ExternalChannelOpenedEvent `protobuf:"bytes,1,opt,name=external_channel_opened,json=externalChannelOpened,proto3,oneof"`
}

type ChannelEvent_ExternalChannelClosed struct {
	ExternalChannelClosed *ChannelEvent_ExternalChannelClosedEvent `protobuf:"bytes,2,opt,name=external_channel_closed,json=externalChannelClosed,proto3,oneof"`
}

func (*ChannelEvent_ExternalChannelOpened) isChannelEvent_Event() {}

func (*ChannelEvent_ExternalChannelClosed) isChannelEvent_Event() {}
...
type SSHChannelControlAction_HandOff struct {
	...
	HandOff *SSHChannelControlAction_HandOffUpstream `protobuf:"bytes,2,opt,name=hand_off,json=handOff,proto3,oneof"` // BeginUpstreamTunnel begin_upstream_tunnel = 3;
}
...
type ChannelEvent_ExternalChannelOpenedEvent struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ChannelEvent_ExternalChannelOpenedEvent) Reset() {
	*x = ChannelEvent_ExternalChannelOpenedEvent{}
	mi := &file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_msgTypes[34]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ChannelEvent_ExternalChannelOpenedEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChannelEvent_ExternalChannelOpenedEvent) ProtoMessage() {}

func (x *ChannelEvent_ExternalChannelOpenedEvent) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_msgTypes[34]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChannelEvent_ExternalChannelOpenedEvent.ProtoReflect.Descriptor instead.
func (*ChannelEvent_ExternalChannelOpenedEvent) Descriptor() ([]byte, []int) {
	return file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_rawDescGZIP(), []int{6, 0}
}

func (x *ChannelEvent_ExternalChannelOpenedEvent) GetChannelId() uint32 {
	if x != nil {
		return x.ChannelId
	}
	return 0
...
func (x *ChannelEvent_ExternalChannelOpenedEvent) GetRemoteAddress() string {
	if x != nil {
...
type ChannelEvent_ExternalChannelClosedEvent struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ChannelId     uint32                 `protobuf:"varint,1,opt,name=channel_id,json=channelId,proto3" json:"channel_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *ChannelEvent_ExternalChannelClosedEvent) Reset() {
	*x = ChannelEvent_ExternalChannelClosedEvent{}
	mi := &file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_msgTypes[35]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ChannelEvent_ExternalChannelClosedEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChannelEvent_ExternalChannelClosedEvent) ProtoMessage() {}

func (x *ChannelEvent_ExternalChannelClosedEvent) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_msgTypes[35]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChannelEvent_ExternalChannelClosedEvent.ProtoReflect.Descriptor instead.
func (*ChannelEvent_ExternalChannelClosedEvent) Descriptor() ([]byte, []int) {
	return file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_rawDescGZIP(), []int{6, 1}
}

func (x *ChannelEvent_ExternalChannelClosedEvent) GetChannelId() uint32 {
	if x != nil {
		return x.ChannelId
	}
	return 0
...
const file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_rawDesc = "" +
	...
	"\fgrpc_service\x18\x04 \x01(\v2!.envoy.config.core.v3.GrpcServiceB\b\xfaB\x05\x8a\x01\x02\x10\x01R\vgrpcService\x12f\n" +
	"\x15active_stream_tracker\x18\x05 \x01(\v22.pomerium.extensions.ssh.ActiveStreamTrackerConfigR\x13activeStreamTracker\"a\n" +
	"\x19ActiveStreamTrackerConfig\x12D\n" +
	"\afilters\x18\x01 \x03(\v2*.envoy.config.core.v3.TypedExtensionConfigR\afilters\"\x1e\n" +
	"\x1cClusterEndpointManagerConfig\"h\n" +
	"\x0fUpstreamCluster\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12A\n" +
	"\n" +
	"eds_config\x18\x02 \x01(\v2\".envoy.config.core.v3.ConfigSourceR\tedsConfig\"\xb7\x02\n" +
	...
	"\x0fchannel_control\x18\x03 \x01(\v2'.pomerium.extensions.ssh.ChannelControlH\x00R\x0echannelControl\x12L\n" +
	"\rchannel_event\x18\x04 \x01(\v2%.pomerium.extensions.ssh.ChannelEventH\x00R\fchannelEventB\t\n" +
	"\amessage\"i\n" +
	"\x0eChannelControl\x12\x1a\n" +
	"\bprotocol\x18\x01 \x01(\tR\bprotocol\x12;\n" +
	"\x0econtrol_action\x18\x02 \x01(\v2\x14.google.protobuf.AnyR\rcontrolAction\"\xb0\x03\n" +
	"\fChannelEvent\x12z\n" +
	"\x17external_channel_opened\x18\x01 \x01(\v2@.pomerium.extensions.ssh.ChannelEvent.ExternalChannelOpenedEventH\x00R\x15externalChannelOpened\x12z\n" +
	"\x17external_channel_closed\x18\x02 \x01(\v2@.pomerium.extensions.ssh.ChannelEvent.ExternalChannelClosedEventH\x00R\x15externalChannelClosed\x1ab\n" +
	"\x1aExternalChannelOpenedEvent\x12\x1d\n" +
	"\n" +
	"channel_id\x18\x01 \x01(\rR\tchannelId\x12%\n" +
	"\x0eremote_address\x18\x02 \x01(\tR\rremoteAddress\x1a;\n" +
	"\x1aExternalChannelClosedEvent\x12\x1d\n" +
	"\n" +
	"channel_id\x18\x01 \x01(\rR\tchannelIdB\a\n" +
	"\x05event\"\xfb\x01\n" +
	"\rClientMessage\x12<\n" +
...
var file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_msgTypes = make([]protoimpl.MessageInfo, 40)
var file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_goTypes = []any{
	...
	(*ActiveStreamTrackerConfig)(nil),               // 2: pomerium.extensions.ssh.ActiveStreamTrackerConfig
	(*ClusterEndpointManagerConfig)(nil),            // 3: pomerium.extensions.ssh.ClusterEndpointManagerConfig
	(*UpstreamCluster)(nil),                         // 4: pomerium.extensions.ssh.UpstreamCluster
	(*ChannelMessage)(nil),                          // 5: pomerium.extensions.ssh.ChannelMessage
	(*ChannelControl)(nil),                          // 6: pomerium.extensions.ssh.ChannelControl
	(*ChannelEvent)(nil),                            // 7: pomerium.extensions.ssh.ChannelEvent
	...
	(*ChannelEvent_ExternalChannelOpenedEvent)(nil), // 35: pomerium.extensions.ssh.ChannelEvent.ExternalChannelOpenedEvent
	(*ChannelEvent_ExternalChannelClosedEvent)(nil), // 36: pomerium.extensions.ssh.ChannelEvent.ExternalChannelClosedEvent
	(*SSHChannelControlAction_HandOffUpstream)(nil), // 37: pomerium.extensions.ssh.SSHChannelControlAction.HandOffUpstream
	nil, // 38: pomerium.extensions.ssh.KeyboardInteractiveAllowResponse.ClaimsEntry
	(*KeyboardInteractiveInfoPrompts_Prompt)(nil), // 39: pomerium.extensions.ssh.KeyboardInteractiveInfoPrompts.Prompt
	nil,                             // 40: pomerium.extensions.ssh.Permissions.ForceEnvEntry
	(*v3.DataSource)(nil),           // 41: envoy.config.core.v3.DataSource
	(*wrapperspb.UInt64Value)(nil),  // 42: google.protobuf.UInt64Value
	(*v3.GrpcService)(nil),          // 43: envoy.config.core.v3.GrpcService
	(*v3.TypedExtensionConfig)(nil), // 44: envoy.config.core.v3.TypedExtensionConfig
	(*v3.ConfigSource)(nil),         // 45: envoy.config.core.v3.ConfigSource
	(*v3.Metadata)(nil),             // 46: envoy.config.core.v3.Metadata
...
var file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_depIdxs = []int32{
	41, // 0: pomerium.extensions.ssh.CodecConfig.host_keys:type_name -> envoy.config.core.v3.DataSource
	41, // 1: pomerium.extensions.ssh.CodecConfig.user_ca_key:type_name -> envoy.config.core.v3.DataSource
	42, // 2: pomerium.extensions.ssh.CodecConfig.rekey_threshold:type_name -> google.protobuf.UInt64Value
	43, // 3: pomerium.extensions.ssh.CodecConfig.grpc_service:type_name -> envoy.config.core.v3.GrpcService
	2,  // 4: pomerium.extensions.ssh.CodecConfig.active_stream_tracker:type_name -> pomerium.extensions.ssh.ActiveStreamTrackerConfig
	44, // 5: pomerium.extensions.ssh.ActiveStreamTrackerConfig.filters:type_name -> envoy.config.core.v3.TypedExtensionConfig
	45, // 6: pomerium.extensions.ssh.UpstreamCluster.eds_config:type_name -> envoy.config.core.v3.ConfigSource
	46, // 7: pomerium.extensions.ssh.ChannelMessage.metadata:type_name -> envoy.config.core.v3.Metadata
	47, // 8: pomerium.extensions.ssh.ChannelMessage.raw_bytes:type_name -> google.protobuf.BytesValue
	6,  // 9: pomerium.extensions.ssh.ChannelMessage.channel_control:type_name -> pomerium.extensions.ssh.ChannelControl
	7,  // 10: pomerium.extensions.ssh.ChannelMessage.channel_event:type_name -> pomerium.extensions.ssh.ChannelEvent
	48, // 11: pomerium.extensions.ssh.ChannelControl.control_action:type_name -> google.protobuf.Any
	35, // 12: pomerium.extensions.ssh.ChannelEvent.external_channel_opened:type_name -> pomerium.extensions.ssh.ChannelEvent.ExternalChannelOpenedEvent
	36, // 13: pomerium.extensions.ssh.ChannelEvent.external_channel_closed:type_name -> pomerium.extensions.ssh.ChannelEvent.ExternalChannelClosedEvent
	9,  // 14: pomerium.extensions.ssh.ClientMessage.event:type_name -> pomerium.extensions.ssh.StreamEvent
	13, // 15: pomerium.extensions.ssh.ClientMessage.auth_request:type_name -> pomerium.extensions.ssh.AuthenticationRequest
	14, // 16: pomerium.extensions.ssh.ClientMessage.info_response:type_name -> pomerium.extensions.ssh.InfoResponse
	10, // 17: pomerium.extensions.ssh.StreamEvent.downstream_connected:type_name -> pomerium.extensions.ssh.DownstreamConnectEvent
	11, // 18: pomerium.extensions.ssh.StreamEvent.downstream_disconnected:type_name -> pomerium.extensions.ssh.DownstreamDisconnectedEvent
	12, // 19: pomerium.extensions.ssh.StreamEvent.upstream_connected:type_name -> pomerium.extensions.ssh.UpstreamConnectEvent
	48, // 20: pomerium.extensions.ssh.AuthenticationRequest.method_request:type_name -> google.protobuf.Any
	48, // 21: pomerium.extensions.ssh.InfoResponse.response:type_name -> google.protobuf.Any
	16, // 22: pomerium.extensions.ssh.ServerMessage.auth_response:type_name -> pomerium.extensions.ssh.AuthenticationResponse
	17, // 23: pomerium.extensions.ssh.AuthenticationResponse.allow:type_name -> pomerium.extensions.ssh.AllowResponse
	22, // 24: pomerium.extensions.ssh.AuthenticationResponse.deny:type_name -> pomerium.extensions.ssh.DenyResponse
	23, // 25: pomerium.extensions.ssh.AuthenticationResponse.info_request:type_name -> pomerium.extensions.ssh.InfoRequest
	18, // 26: pomerium.extensions.ssh.AllowResponse.upstream:type_name -> pomerium.extensions.ssh.UpstreamTarget
	19, // 27: pomerium.extensions.ssh.AllowResponse.internal:type_name -> pomerium.extensions.ssh.InternalTarget
	20, // 28: pomerium.extensions.ssh.AllowResponse.mirror_session:type_name -> pomerium.extensions.ssh.MirrorSessionTarget
	21, // 29: pomerium.extensions.ssh.UpstreamTarget.allowed_methods:type_name -> pomerium.extensions.ssh.AllowedMethod
	44, // 30: pomerium.extensions.ssh.UpstreamTarget.extensions:type_name -> envoy.config.core.v3.TypedExtensionConfig
	46, // 31: pomerium.extensions.ssh.InternalTarget.set_metadata:type_name -> envoy.config.core.v3.Metadata
	0,  // 32: pomerium.extensions.ssh.MirrorSessionTarget.mode:type_name -> pomerium.extensions.ssh.MirrorSessionTarget.Mode
	48, // 33: pomerium.extensions.ssh.AllowedMethod.method_data:type_name -> google.protobuf.Any
	48, // 34: pomerium.extensions.ssh.InfoRequest.request:type_name -> google.protobuf.Any
	37, // 35: pomerium.extensions.ssh.SSHChannelControlAction.hand_off:type_name -> pomerium.extensions.ssh.SSHChannelControlAction.HandOffUpstream
	33, // 36: pomerium.extensions.ssh.PublicKeyAllowResponse.permissions:type_name -> pomerium.extensions.ssh.Permissions
	38, // 37: pomerium.extensions.ssh.KeyboardInteractiveAllowResponse.claims:type_name -> pomerium.extensions.ssh.KeyboardInteractiveAllowResponse.ClaimsEntry
	39, // 38: pomerium.extensions.ssh.KeyboardInteractiveInfoPrompts.prompts:type_name -> pomerium.extensions.ssh.KeyboardInteractiveInfoPrompts.Prompt
	49, // 39: pomerium.extensions.ssh.Permissions.valid_start_time:type_name -> google.protobuf.Timestamp
	49, // 40: pomerium.extensions.ssh.Permissions.valid_end_time:type_name -> google.protobuf.Timestamp
	40, // 41: pomerium.extensions.ssh.Permissions.force_env:type_name -> pomerium.extensions.ssh.Permissions.ForceEnvEntry
	24, // 42: pomerium.extensions.ssh.SSHChannelControlAction.HandOffUpstream.downstream_channel_info:type_name -> pomerium.extensions.ssh.SSHDownstreamChannelInfo
	25, // 43: pomerium.extensions.ssh.SSHChannelControlAction.HandOffUpstream.downstream_pty_info:type_name -> pomerium.extensions.ssh.SSHDownstreamPTYInfo
	17, // 44: pomerium.extensions.ssh.SSHChannelControlAction.HandOffUpstream.upstream_auth:type_name -> pomerium.extensions.ssh.AllowResponse
	50, // 45: pomerium.extensions.ssh.KeyboardInteractiveAllowResponse.ClaimsEntry.value:type_name -> google.protobuf.ListValue
	8,  // 46: pomerium.extensions.ssh.StreamManagement.ManageStream:input_type -> pomerium.extensions.ssh.ClientMessage
	5,  // 47: pomerium.extensions.ssh.StreamManagement.ServeChannel:input_type -> pomerium.extensions.ssh.ChannelMessage
	15, // 48: pomerium.extensions.ssh.StreamManagement.ManageStream:output_type -> pomerium.extensions.ssh.ServerMessage
	5,  // 49: pomerium.extensions.ssh.StreamManagement.ServeChannel:output_type -> pomerium.extensions.ssh.ChannelMessage
...
func file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_init() {
	...
	file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_msgTypes[8].OneofWrappers = []any{
