...
type SSHChannelControlAction struct {
	...
	//	*SSHChannelControlAction_BeginUpstreamTunnel
...
func (x *SSHChannelControlAction) GetBeginUpstreamTunnel() *BeginUpstreamTunnel {
	if x != nil {
		if x, ok := x.Action.(*SSHChannelControlAction_BeginUpstreamTunnel); ok {
			return x.BeginUpstreamTunnel
		}
	}
	return nil
}
...
type SSHChannelControlAction_BeginUpstreamTunnel struct {
	BeginUpstreamTunnel *BeginUpstreamTunnel `protobuf:"bytes,3,opt,name=begin_upstream_tunnel,json=beginUpstreamTunnel,proto3,oneof"`
}

func (*SSHChannelControlAction_HandOff) isSSHChannelControlAction_Action() {}

func (*SSHChannelControlAction_BeginUpstreamTunnel) isSSHChannelControlAction_Action() {}

type BeginUpstreamTunnel struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *BeginUpstreamTunnel) Reset() {
	*x = BeginUpstreamTunnel{}
	mi := &file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BeginUpstreamTunnel) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BeginUpstreamTunnel) ProtoMessage() {}

func (x *BeginUpstreamTunnel) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_msgTypes[24]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BeginUpstreamTunnel.ProtoReflect.Descriptor instead.
func (*BeginUpstreamTunnel) Descriptor() ([]byte, []int) {
	return file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_rawDescGZIP(), []int{24}
}

func (x *BeginUpstreamTunnel) GetClusterId() string {
	if x != nil {
		return x.ClusterId
	}
	return ""
...
func (*ChannelEvent_ExternalChannelOpenedEvent) Descriptor() ([]byte, []int) {
	return file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_rawDescGZIP(), []int{4, 0}
}
...
func (*ChannelEvent_ExternalChannelClosedEvent) Descriptor() ([]byte, []int) {
	return file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_rawDescGZIP(), []int{4, 1}
}
...
func (*SSHChannelControlAction_HandOffUpstream) Descriptor() ([]byte, []int) {
	return file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_rawDescGZIP(), []int{23, 0}
}
...
const file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_rawDesc = "" +
	...
	"\fgrpc_service\x18\x04 \x01(\v2!.envoy.config.core.v3.GrpcServiceB\b\xfaB\x05\x8a\x01\x02\x10\x01R\vgrpcService\"%\n" +
	...
	"\x05modes\x18\x06 \x01(\fR\x05modes\"\x91\x04\n" +
	"\x17SSHChannelControlAction\x12]\n" +
	"\bhand_off\x18\x02 \x01(\v2@.pomerium.extensions.ssh.SSHChannelControlAction.HandOffUpstreamH\x00R\ahandOff\x12b\n" +
	"\x15begin_upstream_tunnel\x18\x03 \x01(\v2,.pomerium.extensions.ssh.BeginUpstreamTunnelH\x00R\x13beginUpstreamTunnel\x1a\xa8\x02\n" +
	...
	"\x06action\"4\n" +
	"\x13BeginUpstreamTunnel\x12\x1d\n" +
	"\n" +
	"cluster_id\x18\x01 \x01(\tR\tclusterId\"\xa0\x01\n" +
...
var file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_msgTypes = make([]protoimpl.MessageInfo, 39)
var file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_goTypes = []any{
	...
	(*SSHDownstreamChannelInfo)(nil),                // 22: pomerium.extensions.ssh.SSHDownstreamChannelInfo
	(*SSHDownstreamPTYInfo)(nil),                    // 23: pomerium.extensions.ssh.SSHDownstreamPTYInfo
	(*SSHChannelControlAction)(nil),                 // 24: pomerium.extensions.ssh.SSHChannelControlAction
	(*BeginUpstreamTunnel)(nil),                     // 25: pomerium.extensions.ssh.BeginUpstreamTunnel
	...
	(*ChannelEvent_ExternalChannelOpenedEvent)(nil), // 34: pomerium.extensions.ssh.ChannelEvent.ExternalChannelOpenedEvent
	(*ChannelEvent_ExternalChannelClosedEvent)(nil), // 35: pomerium.extensions.ssh.ChannelEvent.ExternalChannelClosedEvent
	(*SSHChannelControlAction_HandOffUpstream)(nil), // 36: pomerium.extensions.ssh.SSHChannelControlAction.HandOffUpstream
	nil, // 37: pomerium.extensions.ssh.KeyboardInteractiveAllowResponse.ClaimsEntry
	(*KeyboardInteractiveInfoPrompts_Prompt)(nil), // 38: pomerium.extensions.ssh.KeyboardInteractiveInfoPrompts.Prompt
	nil,                             // 39: pomerium.extensions.ssh.Permissions.ForceEnvEntry
	(*v3.DataSource)(nil),           // 40: envoy.config.core.v3.DataSource
	(*wrapperspb.UInt64Value)(nil),  // 41: google.protobuf.UInt64Value
	(*v3.GrpcService)(nil),          // 42: envoy.config.core.v3.GrpcService
	(*v3.Metadata)(nil),             // 43: envoy.config.core.v3.Metadata
	(*wrapperspb.BytesValue)(nil),   // 44: google.protobuf.BytesValue
	(*anypb.Any)(nil),               // 45: google.protobuf.Any
	(*v3.TypedExtensionConfig)(nil), // 46: envoy.config.core.v3.TypedExtensionConfig
...
var file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_depIdxs = []int32{
	40, // 0: pomerium.extensions.ssh.CodecConfig.host_keys:type_name -> envoy.config.core.v3.DataSource
	40, // 1: pomerium.extensions.ssh.CodecConfig.user_ca_key:type_name -> envoy.config.core.v3.DataSource
	41, // 2: pomerium.extensions.ssh.CodecConfig.rekey_threshold:type_name -> google.protobuf.UInt64Value
	42, // 3: pomerium.extensions.ssh.CodecConfig.grpc_service:type_name -> envoy.config.core.v3.GrpcService
	43, // 4: pomerium.extensions.ssh.ChannelMessage.metadata:type_name -> envoy.config.core.v3.Metadata
	44, // 5: pomerium.extensions.ssh.ChannelMessage.raw_bytes:type_name -> google.protobuf.BytesValue
	4,  // 6: pomerium.extensions.ssh.ChannelMessage.channel_control:type_name -> pomerium.extensions.ssh.ChannelControl
	5,  // 7: pomerium.extensions.ssh.ChannelMessage.channel_event:type_name -> pomerium.extensions.ssh.ChannelEvent
	45, // 8: pomerium.extensions.ssh.ChannelControl.control_action:type_name -> google.protobuf.Any
	34, // 9: pomerium.extensions.ssh.ChannelEvent.external_channel_opened:type_name -> pomerium.extensions.ssh.ChannelEvent.ExternalChannelOpenedEvent
	35, // 10: pomerium.extensions.ssh.ChannelEvent.external_channel_closed:type_name -> pomerium.extensions.ssh.ChannelEvent.ExternalChannelClosedEvent
	7,  // 11: pomerium.extensions.ssh.ClientMessage.event:type_name -> pomerium.extensions.ssh.StreamEvent
	11, // 12: pomerium.extensions.ssh.ClientMessage.auth_request:type_name -> pomerium.extensions.ssh.AuthenticationRequest
	12, // 13: pomerium.extensions.ssh.ClientMessage.info_response:type_name -> pomerium.extensions.ssh.InfoResponse
	...
	45, // 17: pomerium.extensions.ssh.AuthenticationRequest.method_request:type_name -> google.protobuf.Any
	45, // 18: pomerium.extensions.ssh.InfoResponse.response:type_name -> google.protobuf.Any
	14, // 19: pomerium.extensions.ssh.ServerMessage.auth_response:type_name -> pomerium.extensions.ssh.AuthenticationResponse
	15, // 20: pomerium.extensions.ssh.AuthenticationResponse.allow:type_name -> pomerium.extensions.ssh.AllowResponse
	20, // 21: pomerium.extensions.ssh.AuthenticationResponse.deny:type_name -> pomerium.extensions.ssh.DenyResponse
	21, // 22: pomerium.extensions.ssh.AuthenticationResponse.info_request:type_name -> pomerium.extensions.ssh.InfoRequest
	16, // 23: pomerium.extensions.ssh.AllowResponse.upstream:type_name -> pomerium.extensions.ssh.UpstreamTarget
	17, // 24: pomerium.extensions.ssh.AllowResponse.internal:type_name -> pomerium.extensions.ssh.InternalTarget
	18, // 25: pomerium.extensions.ssh.AllowResponse.mirror_session:type_name -> pomerium.extensions.ssh.MirrorSessionTarget
	19, // 26: pomerium.extensions.ssh.UpstreamTarget.allowed_methods:type_name -> pomerium.extensions.ssh.AllowedMethod
	46, // 27: pomerium.extensions.ssh.UpstreamTarget.extensions:type_name -> envoy.config.core.v3.TypedExtensionConfig
	43, // 28: pomerium.extensions.ssh.InternalTarget.set_metadata:type_name -> envoy.config.core.v3.Metadata
	0,  // 29: pomerium.extensions.ssh.MirrorSessionTarget.mode:type_name -> pomerium.extensions.ssh.MirrorSessionTarget.Mode
	45, // 30: pomerium.extensions.ssh.AllowedMethod.method_data:type_name -> google.protobuf.Any
	45, // 31: pomerium.extensions.ssh.InfoRequest.request:type_name -> google.protobuf.Any
	36, // 32: pomerium.extensions.ssh.SSHChannelControlAction.hand_off:type_name -> pomerium.extensions.ssh.SSHChannelControlAction.HandOffUpstream
	25, // 33: pomerium.extensions.ssh.SSHChannelControlAction.begin_upstream_tunnel:type_name -> pomerium.extensions.ssh.BeginUpstreamTunnel
	32, // 34: pomerium.extensions.ssh.PublicKeyAllowResponse.permissions:type_name -> pomerium.extensions.ssh.Permissions
	37, // 35: pomerium.extensions.ssh.KeyboardInteractiveAllowResponse.claims:type_name -> pomerium.extensions.ssh.KeyboardInteractiveAllowResponse.ClaimsEntry
	38, // 36: pomerium.extensions.ssh.KeyboardInteractiveInfoPrompts.prompts:type_name -> pomerium.extensions.ssh.KeyboardInteractiveInfoPrompts.Prompt
	47, // 37: pomerium.extensions.ssh.Permissions.valid_start_time:type_name -> google.protobuf.Timestamp
	47, // 38: pomerium.extensions.ssh.Permissions.valid_end_time:type_name -> google.protobuf.Timestamp
	39, // 39: pomerium.extensions.ssh.Permissions.force_env:type_name -> pomerium.extensions.ssh.Permissions.ForceEnvEntry
	22, // 40: pomerium.extensions.ssh.SSHChannelControlAction.HandOffUpstream.downstream_channel_info:type_name -> pomerium.extensions.ssh.SSHDownstreamChannelInfo
	23, // 41: pomerium.extensions.ssh.SSHChannelControlAction.HandOffUpstream.downstream_pty_info:type_name -> pomerium.extensions.ssh.SSHDownstreamPTYInfo
	15, // 42: pomerium.extensions.ssh.SSHChannelControlAction.HandOffUpstream.upstream_auth:type_name -> pomerium.extensions.ssh.AllowResponse
	48, // 43: pomerium.extensions.ssh.KeyboardInteractiveAllowResponse.ClaimsEntry.value:type_name -> google.protobuf.ListValue
	6,  // 44: pomerium.extensions.ssh.StreamManagement.ManageStream:input_type -> pomerium.extensions.ssh.ClientMessage
	3,  // 45: pomerium.extensions.ssh.StreamManagement.ServeChannel:input_type -> pomerium.extensions.ssh.ChannelMessage
	13, // 46: pomerium.extensions.ssh.StreamManagement.ManageStream:output_type -> pomerium.extensions.ssh.ServerMessage
	3,  // 47: pomerium.extensions.ssh.StreamManagement.ServeChannel:output_type -> pomerium.extensions.ssh.ChannelMessage
...
func file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_init() {
	...
	file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_msgTypes[23].OneofWrappers = []any{
		...
		(*SSHChannelControlAction_BeginUpstreamTunnel)(nil),
	}
	type x struct{}
