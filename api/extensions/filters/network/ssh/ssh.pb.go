...
func (*SSHChannelControlAction_HandOffUpstream) Descriptor() ([]byte, []int) {
	return file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_rawDescGZIP(), []int{23, 1}
}
...
var file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_goTypes = []any{
	...
	(*StreamControl)(nil),                           // 21: pomerium.extensions.ssh.StreamControl
	...
	(*PublicKeyMethodRequest)(nil),                  // 25: pomerium.extensions.ssh.PublicKeyMethodRequest
	(*PublicKeyAllowResponse)(nil),                  // 26: pomerium.extensions.ssh.PublicKeyAllowResponse
	(*KeyboardInteractiveMethodRequest)(nil),        // 27: pomerium.extensions.ssh.KeyboardInteractiveMethodRequest
	(*KeyboardInteractiveAllowResponse)(nil),        // 28: pomerium.extensions.ssh.KeyboardInteractiveAllowResponse
	(*KeyboardInteractiveInfoPrompts)(nil),          // 29: pomerium.extensions.ssh.KeyboardInteractiveInfoPrompts
	(*KeyboardInteractiveInfoPromptResponses)(nil),  // 30: pomerium.extensions.ssh.KeyboardInteractiveInfoPromptResponses
	(*Permissions)(nil),                             // 31: pomerium.extensions.ssh.Permissions
	(*StreamControl_CloseStream)(nil),               // 32: pomerium.extensions.ssh.StreamControl.CloseStream
	(*SSHChannelControlAction_Disconnect)(nil),      // 33: pomerium.extensions.ssh.SSHChannelControlAction.Disconnect
	(*SSHChannelControlAction_HandOffUpstream)(nil), // 34: pomerium.extensions.ssh.SSHChannelControlAction.HandOffUpstream
	nil, // 35: pomerium.extensions.ssh.KeyboardInteractiveAllowResponse.ClaimsEntry
...
var file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_ssh_proto_depIdxs = []int32{
	38, // 0: pomerium.extensions.ssh.CodecConfig.grpc_service:type_name -> envoy.config.core.v3.GrpcService
	39, // 1: pomerium.extensions.ssh.ChannelMessage.metadata:type_name -> envoy.config.core.v3.Metadata
	40, // 2: pomerium.extensions.ssh.ChannelMessage.raw_bytes:type_name -> google.protobuf.BytesValue
	4,  // 3: pomerium.extensions.ssh.ChannelMessage.channel_control:type_name -> pomerium.extensions.ssh.ChannelControl
	41, // 4: pomerium.extensions.ssh.ChannelControl.control_action:type_name -> google.protobuf.Any
	6,  // 5: pomerium.extensions.ssh.ClientMessage.event:type_name -> pomerium.extensions.ssh.StreamEvent
	10, // 6: pomerium.extensions.ssh.ClientMessage.auth_request:type_name -> pomerium.extensions.ssh.AuthenticationRequest
	11, // 7: pomerium.extensions.ssh.ClientMessage.info_response:type_name -> pomerium.extensions.ssh.InfoResponse
	7,  // 8: pomerium.extensions.ssh.StreamEvent.downstream_connected:type_name -> pomerium.extensions.ssh.DownstreamConnectEvent
	8,  // 9: pomerium.extensions.ssh.StreamEvent.downstream_disconnected:type_name -> pomerium.extensions.ssh.DownstreamDisconnectedEvent
	9,  // 10: pomerium.extensions.ssh.StreamEvent.upstream_connected:type_name -> pomerium.extensions.ssh.UpstreamConnectEvent
	41, // 11: pomerium.extensions.ssh.AuthenticationRequest.method_request:type_name -> google.protobuf.Any
	41, // 12: pomerium.extensions.ssh.InfoResponse.response:type_name -> google.protobuf.Any
	13, // 13: pomerium.extensions.ssh.ServerMessage.auth_response:type_name -> pomerium.extensions.ssh.AuthenticationResponse
	21, // 14: pomerium.extensions.ssh.ServerMessage.stream_control:type_name -> pomerium.extensions.ssh.StreamControl
	14, // 15: pomerium.extensions.ssh.AuthenticationResponse.allow:type_name -> pomerium.extensions.ssh.AllowResponse
	19, // 16: pomerium.extensions.ssh.AuthenticationResponse.deny:type_name -> pomerium.extensions.ssh.DenyResponse
	20, // 17: pomerium.extensions.ssh.AuthenticationResponse.info_request:type_name -> pomerium.extensions.ssh.InfoRequest
	15, // 18: pomerium.extensions.ssh.AllowResponse.upstream:type_name -> pomerium.extensions.ssh.UpstreamTarget
	16, // 19: pomerium.extensions.ssh.AllowResponse.internal:type_name -> pomerium.extensions.ssh.InternalTarget
	17, // 20: pomerium.extensions.ssh.AllowResponse.mirror_session:type_name -> pomerium.extensions.ssh.MirrorSessionTarget
	18, // 21: pomerium.extensions.ssh.UpstreamTarget.allowed_methods:type_name -> pomerium.extensions.ssh.AllowedMethod
	42, // 22: pomerium.extensions.ssh.UpstreamTarget.extensions:type_name -> envoy.config.core.v3.TypedExtensionConfig
	39, // 23: pomerium.extensions.ssh.InternalTarget.set_metadata:type_name -> envoy.config.core.v3.Metadata
	0,  // 24: pomerium.extensions.ssh.MirrorSessionTarget.mode:type_name -> pomerium.extensions.ssh.MirrorSessionTarget.Mode
	41, // 25: pomerium.extensions.ssh.AllowedMethod.method_data:type_name -> google.protobuf.Any
	41, // 26: pomerium.extensions.ssh.InfoRequest.request:type_name -> google.protobuf.Any
	32, // 27: pomerium.extensions.ssh.StreamControl.close_stream:type_name -> pomerium.extensions.ssh.StreamControl.CloseStream
	33, // 28: pomerium.extensions.ssh.SSHChannelControlAction.disconnect:type_name -> pomerium.extensions.ssh.SSHChannelControlAction.Disconnect
	34, // 29: pomerium.extensions.ssh.SSHChannelControlAction.hand_off:type_name -> pomerium.extensions.ssh.SSHChannelControlAction.HandOffUpstream
	31, // 30: pomerium.extensions.ssh.PublicKeyAllowResponse.permissions:type_name -> pomerium.extensions.ssh.Permissions
	35, // 31: pomerium.extensions.ssh.KeyboardInteractiveAllowResponse.claims:type_name -> pomerium.extensions.ssh.KeyboardInteractiveAllowResponse.ClaimsEntry
	...
	22, // 36: pomerium.extensions.ssh.SSHChannelControlAction.HandOffUpstream.downstream_channel_info:type_name -> pomerium.extensions.ssh.SSHDownstreamChannelInfo
	23, // 37: pomerium.extensions.ssh.SSHChannelControlAction.HandOffUpstream.downstream_pty_info:type_name -> pomerium.extensions.ssh.SSHDownstreamPTYInfo
	14, // 38: pomerium.extensions.ssh.SSHChannelControlAction.HandOffUpstream.upstream_auth:type_name -> pomerium.extensions.ssh.AllowResponse
	44, // 39: pomerium.extensions.ssh.KeyboardInteractiveAllowResponse.ClaimsEntry.value:type_name -> google.protobuf.ListValue
	5,  // 40: pomerium.extensions.ssh.StreamManagement.ManageStream:input_type -> pomerium.extensions.ssh.ClientMessage
	3,  // 41: pomerium.extensions.ssh.StreamManagement.ServeChannel:input_type -> pomerium.extensions.ssh.ChannelMessage
	12, // 42: pomerium.extensions.ssh.StreamManagement.ManageStream:output_type -> pomerium.extensions.ssh.ServerMessage
	3,  // 43: pomerium.extensions.ssh.StreamManagement.ServeChannel:output_type -> pomerium.extensions.ssh.ChannelMessage
