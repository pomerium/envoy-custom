...
type Config struct {
	...
	AccessLogStorageDir string `protobuf:"bytes,1,opt,name=access_log_storage_dir,json=accessLogStorageDir,proto3" json:"access_log_storage_dir,omitempty"`
}
...
func (x *Config) GetAccessLogStorageDir() string {
	if x != nil {
		return x.AccessLogStorageDir
	}
	return ""
}
...
type UpstreamTargetExtensionConfig struct {
	...
	RecordSession bool `protobuf:"varint,1,opt,name=record_session,json=recordSession,proto3" json:"record_session,omitempty"`
}
...
func (x *UpstreamTargetExtensionConfig) GetRecordSession() bool {
	if x != nil {
...
var file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_filters_session_recording_session_recording_proto_rawDesc = []byte{
	...
	,
	...
	0x77, 0x6f, 0x72, 0x6b, 0x2f, 0x73, 0x73, 0x68, 0x2f, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73,
...
var file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_filters_session_recording_session_recording_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_github_com_pomerium_envoy_custom_api_extensions_filters_network_ssh_filters_session_recording_session_recording_proto_goTypes = []any{
	(*Config)(nil),                        // 0: pomerium.extensions.ssh.filters.session_recording.Config
	(*UpstreamTargetExtensionConfig)(nil), // 1: pomerium.extensions.ssh.filters.session_recording.UpstreamTargetExtensionConfig
}
